...
# Justfile for QuantumCircuit.jl
...
help-me:
    @echo "=== QuantumCircuit.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/QuantumCircuit.jl/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: QuantumCircuit.jl"
