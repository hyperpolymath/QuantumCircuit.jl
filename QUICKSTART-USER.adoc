= Quantumcircuit.Jl — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/QuantumCircuit.jl
cd QuantumCircuit.jl
...
* https://github.com/hyperpolymath/QuantumCircuit.jl/issues — report bugs
